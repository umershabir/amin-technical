  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <button
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-red-500 to-red-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl active:scale-95"
        aria-label="Call us"
      >
